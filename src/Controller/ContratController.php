...
class ContratController extends AbstractController
{
    ...
    #[Route('/{contratNumber}', name: 'app_contrat_show', methods: ['GET'])]
    ...
    #[Route('/{contratNumber}/edit', name: 'app_contrat_edit', methods: ['GET', 'POST'])]
    ...
    #[Route('/{contratNumber}', name: 'app_contrat_delete', methods: ['POST'])]
    public function delete(Request $request, Contrat $contrat, ContratRepository $contratRepository): Response
    {
        if ($this->isCsrfTokenValid('delete'.$contrat->getContratNumber(), $request->request->get('_token'))) {
