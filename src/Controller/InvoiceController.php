...
class InvoiceController extends AbstractController
{
    ...
    #[Route('/{invoiceNumber}', name: 'app_invoice_show', methods: ['GET'])]
    ...
    #[Route('/{invoiceNumber}/edit', name: 'app_invoice_edit', methods: ['GET', 'POST'])]
    ...
    #[Route('/{invoiceNumber}', name: 'app_invoice_delete', methods: ['POST'])]
